...
class Bigdall:
    ...
    def get_Rect(self):
        if self.see == 1:
            if self.state == self.PUNCH and self.frame == 8:
                draw_rectangle(self.x + (self.see * 70), self.y, self.x + 500, self.y + 400)
            elif self.state == self.SPIN and (self.frame ==8 or self.frame==11):
                draw_rectangle(self.x , self.y, self.x + 600, self.y + 400)
            draw_rectangle(self.x,self.y, self.x+350,self.y+400)
        elif self.see == -1:
            if self.state==self.PUNCH and self.frame==8:
                draw_rectangle(self.x+(self.see*70), self.y, self.x + 350, self.y + 400)
            elif self.state == self.SPIN and (self.frame == 8 or self.frame == 11):
                draw_rectangle(self.x, self.y, self.x + 600, self.y + 400)
            draw_rectangle(self.x,self.y, self.x+350,self.y+400)
    def A_get_bb(self):
        if self.state==self.PUNCH and self.frame==8:
            if self.see ==1:
                return (self.x, self.y, self.x + 350, self.y + 400)
            if self.see == -1:
                return (self.x, self.y, self.x + 350, self.y + 400)
        elif self.state==self.SPIN and (self.frame==8or self.frame==11):
            if self.see ==1:
                return (self.x, self.y, self.x + 350, self.y + 400)
            if self.see == -1:
                return (self.x, self.y, self.x + 350, self.y + 400)
    ...
    def draw(self):
        ...
        if self.see == -1:
            if self.state == 0 or self.state ==8:
                LoadRe.dall.Lstand.clip_draw_to_origin(self.frame * 350, 0, 350, 400, self.x, self.y, 350, 400)
            elif self.state == 1:
                if self.frame<5:
                    LoadRe.dall.Lhit.clip_draw_to_origin(self.frame * 400, 0, 400, 410, self.x, self.y, 400, 410)
                else :
                    LoadRe.dall.Lhit.clip_draw_to_origin((9-self.frame) * 400, 0, 400, 410, self.x, self.y, 400, 410)
            elif self.state == self.PUNCH:
                if self.frame<9:
                    LoadRe.dall.Lpunch.clip_draw_to_origin(self.frame * 640, 400, 640, 400, self.x-70, self.y, 640, 400)
                else:
                    LoadRe.dall.Lpunch.clip_draw_to_origin((self.frame-9) * 640, 0, 640, 400, self.x-70, self.y, 640, 400)
            elif self.state == self.SPIN:
                if self.moveframe <9:
                    LoadRe.dall.spin.clip_draw_to_origin(self.moveframe * 600, 860, 600, 430, self.x, self.y, 600, 430)
                elif self.moveframe <18:
                    LoadRe.dall.spin.clip_draw_to_origin((self.moveframe-9) * 600, 430, 600, 430, self.x, self.y, 600, 430)
                else:
                    LoadRe.dall.spin.clip_draw_to_origin((self.moveframe-18) * 600, 0, 600, 430, self.x, self.y, 600, 430)

        elif self.see ==1:
            if self.state == 0 or self.state ==8:
                LoadRe.dall.Rstand.clip_draw_to_origin(self.frame * 350, 0, 350, 400, self.x, self.y, 350, 400)
            if self.state == 1:
                if self.frame<5:
                    LoadRe.dall.Rhit.clip_draw_to_origin(self.frame * 400, 0, 400, 410, self.x, self.y, 400, 410)
                else:
                    LoadRe.dall.Rhit.clip_draw_to_origin((9-self.frame) * 400, 0, 400, 410, self.x, self.y, 400,410)
            if self.state == self.PUNCH:
                if self.frame<9:
                    LoadRe.dall.Rpunch.clip_draw_to_origin(self.frame * 640, 400, 640, 400, self.x-70, self.y, 640, 400)
                else:
                    LoadRe.dall.Rpunch.clip_draw_to_origin((self.frame-9) * 640, 0, 640, 400, self.x-70, self.y, 640, 400)
            elif self.state == self.SPIN:
                if self.moveframe <9:
                    LoadRe.dall.Rspin.clip_draw_to_origin(self.moveframe * 600, 860, 600, 430, self.x, self.y, 600, 430)
                elif self.moveframe <18:
                    LoadRe.dall.Rspin.clip_draw_to_origin((self.moveframe-9) * 600, 430, 600, 430, self.x, self.y, 600, 430)
                else:
                    LoadRe.dall.Rspin.clip_draw_to_origin((self.moveframe-18) * 600, 0, 600, 430, self.x, self.y, 600, 430)
